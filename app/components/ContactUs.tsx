          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">contact@blockbusterui.com</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">+1 (888) 888-8888</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">4517 Washington Ave. Manchester, Kentucky 39495</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <form className="space-y-6">
              ...
              <div>
                ...
                ></textarea>
                <p className="mt-1 text-xs text-gray-500">Hint: We won&apos;t be spamming.</p>
              </div>
