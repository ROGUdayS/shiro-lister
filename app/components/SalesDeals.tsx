...
const SalesDeals = () => {
  const calculateTimeLeft = () => {
    const targetDate = new Date("2025-04-30T14:00:00"); // April 30th, 2025 at 2 PM
    const now = new Date();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center">
            ...
            <h3 className="text-7xl font-bold mb-10 text-black">
              Deals-2025
              <br />
              Starting
              <br />
            ...
            <div className="mt-8">
              <div className="flex flex-col items-start">
                <h4 className="text-7xl font-bold text-black mb-1 text-left">
                  125k+
                </h4>
                ...
                <div className="flex items-start">
                  <div className="flex -space-x-2 mr-4 mt-2">
                    {[1, 2, 3, 4, 5, 6, 7].map((num, index) => (
                      ...
                      >
                        <Image
                          src={`/images/landing-page-images/profile-pics/avatar${num}.jpg`}
                          alt={`Customer ${num}`}
                          width={40}
                          height={40}
                  ...
                  <div className="-mt-10">
                    <p className="text-sm text-black text-left">
                      Customer already grabbed the deals another
                      <br />
                      20k registered for taking the deals so dont be late and
                      <br />
          ...
          <div className="text-center">
            <div className="mb-8">
              ...
              <h4 className="text-5xl font-bold text-blue-500 mb-4">
                Flash Sale
              </h4>
              <p className="text-lg mb-6 text-black">
                <span className="font-bold">25% off</span> Lorem Ipsum is simply
              ...
              <p className="text-xl font-bold mb-4 text-black">
                The time is ending soon so dont late
              </p>
              ...
              <div className="text-center">
                <Link
                  href="#contact"
                  className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-full font-semibold inline-block text-lg"
                >
                  Register Now
                </Link>
              </div>
