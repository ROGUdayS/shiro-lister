          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-200">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Olympic-sized swimming pool with adjacent spa and relaxation
                  area.
                </p>
                <div className="flex justify-end">
                  <Link
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-200">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Spacious hall for community events, parties, and private
                  gatherings.
                </p>
                <div className="flex justify-end">
                  <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/road.svg"
                    alt="80 feet road"
                    width={40}
                    height={40}
                ...
                <p className="text-sm">
                  Lorem ipsum amet quam miss nestibulum drana fermen.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/clubhouse.svg"
                    alt="5 clubhouse"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/office.svg"
                    alt="Office"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/retail-hubs.svg"
                    alt="Retail Hubs"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/street-lights.svg"
                    alt="Street Lights"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/parks.svg"
                    alt="Parks"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/cctv.svg"
                    alt="CCTV"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/security.svg"
                    alt="Security"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/avenue-tree.svg"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/landscapes.svg"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/kids.svg"
                    alt="Kids play area"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
            ...
            <div className="bg-white text-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-2xl group">
              <div className="p-6 text-center">
                <div className="flex justify-center mb-4">
                  <Image
                    src="/images/application-icons/utilities-icons/secure.svg"
                    alt="Secure"
                    width={40}
                    height={40}
                    className="text-gray-500 group-hover:text-white transition-colors duration-300"
